    ...
    switch (st) {
      ...
      case 2:
        return (
          <>
            <p className={styles.modalText}>
              You're on a different network. Switch to Intersect Testnet.
            </p>
      ...
      case 3:
        return (
          <>
            <p className={styles.modalText}>
              Oops, you don't have Pearl tokens in your account
            </p>
            <CustomButton
              title="Grab some test tokens"
              handleClick={() =>
                window.open(
                  "https://core.app/en/tools/testnet-faucet/?subnet=intersect&token=intersect",
                  "_blank"
                )
              }
            />
